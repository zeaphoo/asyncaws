...
from clientmaker.utils import CachedProperty
from collections import OrderedDict
from clientmaker.exceptions import MissingServiceIdError
from clientmaker.exceptions import UndefinedModelAttributeError
...
class Shape(object):
    ...
    def __init__(self, shape_name, shape_model, shape_resolver=None):
        ...
        :type shape_resolver: clientmaker.model.ShapeResolver
...
class ServiceModel(object):
    ...
    def __init__(self, service_description, service_name=None):
        ...
        :param service_description: The service description model.  This value
            is obtained from a clientmaker.loader.Loader, or from directly loading
            the file yourself::
        ...
        :param service_name: The name of the service.  Normally this is
            ...
            This is done in a few places in clientmaker (ses instead of email,
    ...
    @classmethod
    def load(cls, data_path, service_name):
        loader = SchemaLoader.get_loader(data_path)
        return cls(loader.load_service_model(service_name, "service"))
...
class OperationModel(object):
    def __init__(self, operation_model, service_model, name=None):
        ...
        :type service_model: clientmaker.model.ServiceModel
...
class DenormalizedStructureBuilder(object):
    ...
    Example usage::
        ...
        # ``shape`` is now an instance of clientmaker.model.StructureShape
    ...
    def build_model(self):
        ...
        :rtype: clientmaker.model.StructureShape
